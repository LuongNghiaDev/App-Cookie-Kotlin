package com.example.appcookieskotlin.fragments.bottomsheet
...
import com.example.appcookieskotlin.databinding.FragmentMealBottomSheetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun observerBottomSheetMeal() {
        viewModel.observeBottomSheetMeal().observe(viewLifecycleOwner, Observer { meal ->
            ...
            binding.tvNameBottomsheet.text = meal.strMeal
